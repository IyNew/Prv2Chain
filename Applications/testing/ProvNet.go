...
type Record struct {
	...
	FutureID string `json:"futureID"`
}

// InitLedger adds a base set of records to the ledger
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	records := []Record{
		{ID: "record1", Header: "blue", Data: "5", FutureID: "None"},
	}
...
func (s *SmartContract) CreateRecord(ctx contractapi.TransactionContextInterface, id string, header string, data string, futureID string) error {
